...
: Read the examples carefully. Choose your data source of one of the provided types.
: Create and implement a new Python file (module) in this folder following the associated example.
...
from datafun_03_analytics.chaupalma_csv_pipeline import run_pipeline
